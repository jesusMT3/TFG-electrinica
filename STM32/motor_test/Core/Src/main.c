...
int main(void)
{
  ...
  BSP_MotorControl_AttachFlagInterrupt(MyFlagInterruptHandler);               //Flag interrupt handler
  BSP_MotorControl_AttachErrorHandler(ErrorHandler_Shield);                   //Error handler
